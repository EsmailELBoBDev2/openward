...
const LANG = {
  ...
  // ---- Smart Phrases ----
  smart_phrases_hint:    { ar: 'اكتب "/" متبوعاً بالاختصار لإدراج قالب جاهز', en: 'Type "/" followed by shortcut to insert template' },
  // ---- Analytics ----
  ...
  analytics_code_blue:   { ar: 'أحداث Code Blue', en: 'Code Blue Events' },
  analytics_top_diag:    { ar: 'أكثر التشخيصات شيوعاً', en: 'Top Diagnoses' },
  // ---- Auto-dose ----
  autodose_label:        { ar: 'حاسبة الجرعة',          en: 'Dose Calculator' },
  autodose_weight:       { ar: 'الوزن (كجم)',           en: 'Weight (kg)' },
  autodose_egfr:         { ar: 'معدل الترشيح الكبيبي',   en: 'eGFR (mL/min)' },
  autodose_recommended:  { ar: 'الجرعة الموصى بها:',    en: 'Recommended dose:' },
  autodose_renal_warn:   { ar: 'تنبيه: قصور كلوي — تخفيض الجرعة', en: 'Renal impairment — dose reduction needed' },
  // ---- Sepsis Alert ----
  sepsis_alert_title:    { ar: 'تنبيه عالي الأولوية: احتمال إنتان', en: 'HIGH PRIORITY: Possible Sepsis' },
  sepsis_criteria:       { ar: 'معايير الإنتان مستوفاة', en: 'Sepsis criteria met' },
  sepsis_acknowledge:    { ar: 'تأكيد التنبيه واتخاذ الإجراء', en: 'Acknowledge & Take Action' },
  sepsis_qsofa:          { ar: 'qSOFA',                  en: 'qSOFA' },
  // ---- NANDA/NIC/NOC ----
  ...
  // ---- Readmission Risk ----
  readmit_risk_title:    { ar: 'مؤشر خطر إعادة الإدخال', en: 'Readmission Risk Score' },
  readmit_risk_low:      { ar: 'منخفض',                 en: 'Low' },
  readmit_risk_med:      { ar: 'متوسط',                 en: 'Medium' },
  readmit_risk_high:     { ar: 'مرتفع',                 en: 'High' },
  readmit_factors:       { ar: 'عوامل الخطر',          en: 'Risk Factors' },

  // ---- Login Screen ----
  app_title:        { ar: 'نظام المعلومات الصحية', en: 'Hospital Information System' },
  app_short:        { ar: 'HIS', en: 'HIS' },
  ...
  login_error_role: { ar: 'حسابك مسجل كـ {role}. يرجى اختيار الدور الصحيح.', en: 'Your account is registered as {role}. Please select the correct role.' },
  login_error_disabled: { ar: 'هذا الحساب معطل. تواصل مع مدير النظام.', en: 'This account is disabled. Contact your IT administrator.' },
  session_expired:  { ar: 'انتهت الجلسة. يرجى تسجيل الدخول مرة أخرى.', en: 'Session expired. Please log in again.' },
  logout_btn:       { ar: 'تسجيل الخروج', en: 'Logout' },
  logout_confirm:   { ar: 'هل تريد تسجيل الخروج؟', en: 'Are you sure you want to logout?' },

  // ---- Roles ----
  role_it_admin:         { ar: 'مدير النظام', en: 'IT Admin' },
  role_hospital_manager: { ar: 'مدير المستشفى', en: 'Hospital Manager' },
  role_consultant:       { ar: 'استشاري / رئيس قسم', en: 'Consultant / Head of Department' },
  role_doctor:           { ar: 'دكتور', en: 'Doctor' },
  role_emergency_doctor: { ar: 'دكتور طوارئ', en: 'Emergency Doctor' },
  role_senior_nurse:     { ar: 'تمريض رئيسي', en: 'Senior Nurse' },
  role_nurse:            { ar: 'ممرضة', en: 'Nurse' },
  role_pharmacist:       { ar: 'صيدلاني', en: 'Pharmacist' },
  role_lab_technician:  { ar: 'فني مختبر', en: 'Lab Technician' },
  role_radiologist:     { ar: 'أخصائي أشعة', en: 'Radiologist' },
  role_receptionist:    { ar: 'موظف استقبال', en: 'Receptionist' },
  role_dietitian:       { ar: 'أخصائي تغذية', en: 'Dietitian' },
  role_social_worker:   { ar: 'أخصائي اجتماعي', en: 'Social Worker' },

  // ---- Departments ----
  dept_emergency:    { ar: 'الطوارئ', en: 'Emergency' },
  dept_internal:     { ar: 'الباطنة', en: 'Internal Medicine' },
  dept_surgery:      { ar: 'الجراحة', en: 'Surgery' },
  dept_icu:          { ar: 'العناية المركزة', en: 'ICU' },
  dept_pediatrics:   { ar: 'الأطفال', en: 'Pediatrics' },
  dept_obgyn:        { ar: 'النساء والتوليد', en: 'Obstetrics & Gynecology' },
  dept_orthopedics:  { ar: 'العظام', en: 'Orthopedics' },
  dept_urology:      { ar: 'المسالك البولية', en: 'Urology' },
  dept_pharmacy:     { ar: 'الصيدلية', en: 'Pharmacy' },
  dept_admin:        { ar: 'الإدارة', en: 'Administration' },
  dept_it:           { ar: 'تقنية المعلومات', en: 'IT' },
  dept_laboratory:   { ar: 'المختبر', en: 'Laboratory' },
  dept_radiology:    { ar: 'الأشعة', en: 'Radiology' },
  dept_dermatology:     { ar: 'الجلدية', en: 'Dermatology' },
  dept_ent:             { ar: 'الأنف والأذن والحنجرة', en: 'ENT' },
  dept_ophthalmology:   { ar: 'طب العيون', en: 'Ophthalmology' },
  dept_psychiatry:      { ar: 'الطب النفسي', en: 'Psychiatry' },
  dept_oncology:        { ar: 'الأورام', en: 'Oncology' },
  dept_nephrology:      { ar: 'الكلى وغسيل الكلى', en: 'Nephrology & Dialysis' },
  dept_pulmonology:     { ar: 'الصدرية والرئوية', en: 'Pulmonology' },
  dept_physiotherapy:   { ar: 'العلاج الطبيعي والتأهيل', en: 'Physiotherapy & Rehab' },
  dept_blood_bank:      { ar: 'بنك الدم', en: 'Blood Bank' },
  dept_medical_records: { ar: 'السجلات الطبية', en: 'Medical Records' },
  dept_reception:       { ar: 'الاستقبال والتسجيل', en: 'Reception & Registration' },
  dept_operating_room:  { ar: 'غرف العمليات', en: 'Operating Room' },
  dept_nutrition:       { ar: 'التغذية العلاجية', en: 'Nutrition & Dietetics' },
  dept_social_work:     { ar: 'الخدمة الاجتماعية', en: 'Social Work' },
  ...
  success_created:   { ar: 'تم الإنشاء بنجاح', en: 'Created successfully' },
  success_updated:   { ar: 'تم التحديث بنجاح', en: 'Updated successfully' },
  success_deleted:   { ar: 'تم الحذف بنجاح', en: 'Deleted successfully' },
  ...
  error_duplicate:   { ar: 'هذا السجل موجود مسبقاً', en: 'This record already exists' },
  ...
  print_wristband:      { ar: 'طباعة سوار المعصم', en: 'Print Wristband' },

  // ---- Conditions ----
  cond_diabetes_t1:     { ar: 'سكري نوع 1', en: 'Type 1 Diabetes' },
  cond_diabetes_t2:     { ar: 'سكري نوع 2', en: 'Type 2 Diabetes' },
  cond_hypertension:    { ar: 'ارتفاع ضغط الدم', en: 'Hypertension' },
  cond_cardiac:         { ar: 'مرض قلبي', en: 'Cardiac Disease' },
  cond_renal_failure:   { ar: 'فشل كلوي', en: 'Renal Failure' },
  cond_ckd:             { ar: 'مرض كلوي مزمن', en: 'Chronic Kidney Disease (CKD)' },
  cond_liver_disease:   { ar: 'مرض كبدي', en: 'Liver Disease' },
  cond_copd:            { ar: 'انسداد رئوي مزمن', en: 'COPD' },
  cond_asthma:          { ar: 'ربو', en: 'Asthma' },
  cond_cancer:          { ar: 'سرطان', en: 'Cancer' },
  cond_stroke_history:  { ar: 'تاريخ سكتة دماغية', en: 'History of Stroke' },
  cond_obesity:         { ar: 'سمنة', en: 'Obesity' },
  cond_thyroid:         { ar: 'اضطراب الغدة الدرقية', en: 'Thyroid Disorder' },
  cond_other:           { ar: 'أخرى', en: 'Other' },
  ...
  discharge_summary:    { ar: 'ملخص الخروج', en: 'Discharge Summary' },
  discharge_diagnosis:  { ar: 'تشخيص الخروج', en: 'Discharge Diagnosis' },
  discharge_meds:       { ar: 'أدوية الخروج', en: 'Discharge Medications' },
  ...
  lab_ordered:    { ar: 'تم الطلب', en: 'Ordered' },
  lab_collected:  { ar: 'تم السحب', en: 'Collected' },
  lab_resulted:   { ar: 'ظهرت النتيجة', en: 'Resulted' },
  lab_reviewed:   { ar: 'تمت المراجعة', en: 'Reviewed' },
  ...
  // ---- Common Lab Tests ----
  lab_cbc:        { ar: 'تحليل دم شامل (CBC)', en: 'Complete Blood Count (CBC)' },
  lab_bmp:        { ar: 'أملاح ووظائف الكلى (BMP)', en: 'Basic Metabolic Panel (BMP)' },
  lab_cmp:        { ar: 'كيمياء شاملة (CMP)', en: 'Comprehensive Metabolic Panel (CMP)' },
  lab_rft:        { ar: 'وظائف الكلى (RFT)', en: 'Renal Function Tests (RFT)' },
  lab_lft:        { ar: 'وظائف الكبد (LFT)', en: 'Liver Function Tests (LFT)' },
  lab_lipid:      { ar: 'دهون الدم', en: 'Lipid Panel' },
  lab_hba1c:      { ar: 'السكر التراكمي (HbA1c)', en: 'HbA1c' },
  lab_fbs:        { ar: 'سكر صائم (FBS)', en: 'Fasting Blood Sugar (FBS)' },
  lab_rbs:        { ar: 'سكر عشوائي (RBS)', en: 'Random Blood Sugar (RBS)' },
  lab_tft:        { ar: 'وظائف الغدة الدرقية (TFT)', en: 'Thyroid Function Tests (TFT)' },
  lab_coag:       { ar: 'تخثر الدم (PT/INR/PTT)', en: 'Coagulation (PT/INR/PTT)' },
  lab_troponin:   { ar: 'تروبونين', en: 'Troponin' },
  lab_dimer:      { ar: 'D-Dimer', en: 'D-Dimer' },
  lab_abg:        { ar: 'غازات الدم الشرياني (ABG)', en: 'Arterial Blood Gas (ABG)' },
  lab_urinalysis: { ar: 'تحليل بول', en: 'Urinalysis' },
  lab_urine_culture: { ar: 'مزرعة بول', en: 'Urine Culture' },
  lab_blood_culture: { ar: 'مزرعة دم', en: 'Blood Culture' },
  lab_crp:        { ar: 'بروتين سي التفاعلي (CRP)', en: 'C-Reactive Protein (CRP)' },
  lab_esr:        { ar: 'سرعة الترسيب (ESR)', en: 'Erythrocyte Sedimentation Rate (ESR)' },
  lab_procalcitonin: { ar: 'بروكالسيتونين', en: 'Procalcitonin' },
  lab_crossmatch: { ar: 'فحص توافق الدم', en: 'Blood Cross-match' },
  lab_type_screen:{ ar: 'فصيلة الدم', en: 'Type and Screen' },
  lab_electrolytes:{ ar: 'أملاح الدم (Na, K, Cl)', en: 'Electrolytes (Na, K, Cl)' },
  lab_magnesium:  { ar: 'مغنيسيوم', en: 'Magnesium' },
  lab_phosphate:  { ar: 'فوسفات', en: 'Phosphate' },
  lab_calcium:    { ar: 'كالسيوم', en: 'Calcium' },
  lab_albumin:    { ar: 'ألبومين', en: 'Albumin' },
  lab_amylase:    { ar: 'أميلاز', en: 'Amylase' },
  lab_lipase:     { ar: 'ليباز', en: 'Lipase' },
  lab_lactate:    { ar: 'لاكتات', en: 'Lactate' },
  lab_bnp:        { ar: 'BNP (مؤشر فشل القلب)', en: 'BNP / NT-proBNP' },

  lab_received:       { ar: 'تم الاستلام', en: 'Received' },
  ...
  lab_turnaround:     { ar: 'الوقت المتوقع', en: 'Expected Turnaround' },
  ...
  lab_my_worklist:    { ar: 'قائمة العمل', en: 'My Worklist' },
  lab_results_entry:  { ar: 'إدخال النتائج', en: 'Results Entry' },

  // Radiology
  rad_order:          { ar: 'طلب أشعة', en: 'Radiology Order' },
  rad_type:           { ar: 'نوع الأشعة', en: 'Imaging Type' },
  rad_body_part:      { ar: 'منطقة الجسم', en: 'Body Part' },
  ...
  proc_steps:           { ar: 'الخطوات', en: 'Steps' },
  proc_warnings:        { ar: 'تحذيرات', en: 'Warnings' },
  proc_supplies:        { ar: 'المستلزمات المطلوبة', en: 'Required Supplies' },
  proc_start:           { ar: 'ابدأ الإجراء', en: 'Start Procedure' },
  proc_complete:        { ar: 'إتمام الإجراء', en: 'Complete Procedure' },
  proc_step_done:       { ar: 'تم', en: 'Done' },
  proc_in_progress:     { ar: 'قيد التنفيذ', en: 'In Progress' },
  ...
  // Smart Suggestions
  smart_suggestions:    { ar: 'اقتراحات ذكية', en: 'Smart Suggestions' },
  smart_suggested_labs: { ar: 'تحاليل مقترحة', en: 'Suggested Lab Tests' },
  smart_suggested_diet: { ar: 'نظام غذائي مقترح', en: 'Suggested Diet' },
  smart_nurse_warning:  { ar: 'تنبيه تمريضي', en: 'Nursing Alert' },
  smart_patient_notes:  { ar: 'ملاحظات المريض', en: 'Patient Notes' },
  smart_drug_condition: { ar: 'تفاعل دواء مع حالة مرضية', en: 'Drug-Condition Interaction' },
  ...
  auto_assign:      { ar: 'توزيع تلقائي', en: 'Auto-Assign' },
  ...
  drug_interaction_red:    { ar: 'تفاعل دوائي خطير! لا يمكن المتابعة بدون تبرير.', en: 'Serious Drug Interaction! Cannot proceed without override reason.' },
  drug_interaction_yellow: { ar: 'تحذير: تفاعل دوائي محتمل. يرجى التأكيد.', en: 'Warning: Potential drug interaction. Please confirm.' },
  drug_interaction_blue:   { ar: 'ملاحظة: مراجعة التفاعل الدوائي مقترحة.', en: 'Note: Drug interaction review suggested.' },
  ...
  not_delivered:     { ar: 'لم يتم التوصيل', en: 'Not Delivered' },
  refused:           { ar: 'رفض المريض', en: 'Patient Refused' },
  npo_warning:       { ar: 'تحذير: هذا المريض ممنوع الأكل والشرب (NPO)', en: 'WARNING: This patient is NPO — Nothing by Mouth' },
  ...
  confirm_delivery:  { ar: 'تأكيد التوصيل', en: 'Confirm Delivery' },
  log_refusal:       { ar: 'تسجيل الرفض', en: 'Log Refusal' },
  refusal_reason:    { ar: 'سبب الرفض', en: 'Reason for Refusal' },
  room:              { ar: 'الغرفة', en: 'Room' },

  // ---- Alerts ----
  alert_red:         { ar: 'تنبيه أحمر — حرج', en: 'RED ALERT — Critical' },
  alert_yellow:      { ar: 'تنبيه أصفر — تحذير', en: 'YELLOW ALERT — Warning' },
  alert_blue:        { ar: 'ملاحظة — اقتراح', en: 'BLUE NOTE — Suggestion' },
  override_reason:   { ar: 'سبب التجاوز', en: 'Override Reason' },
  override_btn:      { ar: 'تجاوز مع ذكر السبب', en: 'Override with Reason' },
  got_it:            { ar: 'فهمت', en: 'Got it' },

  // ---- Review Panel ----
  smart_review:        { ar: 'مراجعة ذكية قبل الإرسال', en: 'Smart Review Before Submit' },
  auto_suggested:      { ar: 'مقترح تلقائي', en: 'Auto-Suggested' },
  reason:              { ar: 'السبب', en: 'Reason' },
  field:               { ar: 'الحقل', en: 'Field' },
  confirm_all_submit:  { ar: 'تأكيد الكل وإرسال', en: 'Confirm All & Submit' },

  // ---- Supply Items ----
  supply_management:   { ar: 'إدارة المستلزمات', en: 'Supply Management' },
  supply_use:          { ar: 'استخدام مستلزم', en: 'Use Supply Item' },
  supply_item:         { ar: 'المستلزم', en: 'Supply Item' },
  quantity:            { ar: 'الكمية', en: 'Quantity' },
  for_patient:         { ar: 'للمريض', en: 'For Patient' },
  ...
  rcp_done:             { ar: 'الزيارات المكتملة', en: 'Completed Visits' },
  ...
  appt_schedule:        { ar: 'جدول المواعيد', en: 'Schedule Appointment' },
  appt_date:            { ar: 'تاريخ الموعد', en: 'Appointment Date' },
  appt_time:            { ar: 'وقت الموعد', en: 'Appointment Time' },
  appt_reason:          { ar: 'سبب الموعد', en: 'Reason' },
  billing_create:       { ar: 'إنشاء فاتورة', en: 'Create Invoice' },
  billing_list:         { ar: 'قائمة الفواتير', en: 'Invoice List' },
  invoice_paid:         { ar: 'مدفوع', en: 'Paid' },
  invoice_unpaid:       { ar: 'غير مدفوع', en: 'Unpaid' },
  invoice_total:        { ar: 'الإجمالي', en: 'Total' },
  bed_ward:             { ar: 'الجناح', en: 'Ward' },
  bed_number:           { ar: 'رقم السرير', en: 'Bed Number' },
  bed_status:           { ar: 'حالة السرير', en: 'Bed Status' },
  bed_occupied:         { ar: 'مشغول', en: 'Occupied' },
  bed_available:        { ar: 'متاح', en: 'Available' },
  visit_status_waiting:  { ar: 'بانتظار', en: 'Waiting' },
  visit_status_in_progress: { ar: 'قيد التقييم', en: 'In Progress' },
  visit_status_done:    { ar: 'مكتمل', en: 'Done' },
  visit_type_walk_in:   { ar: 'حضور مباشر', en: 'Walk-in' },
  visit_type_appointment: { ar: 'موعد مسبق', en: 'Appointment' },
  payment_insurance:    { ar: 'تأمين', en: 'Insurance' },
  payment_cash:         { ar: 'نقدي', en: 'Cash' },
  register_patient_btn: { ar: 'تسجيل', en: 'Register' },
  check_in_btn:         { ar: 'تسجيل الحضور', en: 'Check In' },
  call_patient_btn:     { ar: 'استدعاء', en: 'Call Patient' },
  // HR & Orientation
  orientation_active:   { ar: 'قيد التوجيه', en: 'In Orientation' },
  orientation_completed: { ar: 'أتم التوجيه', en: 'Completed' },
  days_left:            { ar: 'يوم متبقي', en: 'days left' },
  days_completed_lbl:   { ar: 'يوم مكتمل', en: 'days done' },
  current_location_lbl: { ar: 'الموقع الحالي', en: 'Current Location' },
  joining_dept_lbl:     { ar: 'القسم المنضم إليه', en: 'Joining Department' },
  joining_role_lbl:     { ar: 'المسمى الوظيفي', en: 'Role' },
  orientation_start:    { ar: 'تاريخ البداية', en: 'Start Date' },
  orientation_end:      { ar: 'تاريخ الانتهاء', en: 'End Date' },
  mark_day_done:        { ar: 'تسجيل يوم', en: 'Log Day' },
  add_orientee_btn:     { ar: 'إضافة موظف', en: 'Add Staff' },
  ...
  npo_count:            { ar: 'ممنوع بالفم', en: 'NPO' },
  ...
  critical_unacked:     { ar: 'نتائج حرجة غير مؤكدة', en: 'Unacknowledged Critical Results' },
  ...
  critical_ack_required:{ ar: 'يجب تأكيد جميع النتائج الحرجة قبل المتابعة', en: 'All critical results must be acknowledged before proceeding' },
  critical_result_for:  { ar: 'نتيجة حرجة للمريض', en: 'Critical result for patient' },
  critical_value:       { ar: 'القيمة الحرجة', en: 'Critical Value' },
  critical_ordered_by:  { ar: 'طلب بواسطة', en: 'Ordered by' },

  // ---- NEWS2 / qSOFA ----
  news2_score:          { ar: 'درجة NEWS2', en: 'NEWS2 Score' },
  news2_low:            { ar: 'خطر منخفض', en: 'Low Risk' },
  news2_medium:         { ar: 'خطر متوسط — راقب عن كثب', en: 'Medium Risk — Close Monitoring' },
  news2_high:           { ar: 'خطر مرتفع — تصعيد فوري', en: 'HIGH RISK — Escalate Immediately' },
  news2_resp_rate:      { ar: 'معدل التنفس (نفس/دقيقة)', en: 'Respiratory Rate (breaths/min)' },
  news2_on_o2:          { ar: 'على أكسجين تكميلي؟', en: 'On Supplemental O2?' },
  news2_consciousness:  { ar: 'مستوى الوعي', en: 'Consciousness Level' },
  news2_alert:          { ar: 'يقظ', en: 'Alert' },
  news2_cvpu:           { ar: 'تشوش / يستجيب للصوت / للألم / لا يستجيب', en: 'Confused / Voice / Pain / Unresponsive' },
  news2_alert_title:    { ar: 'تنبيه NEWS2 — المريض يحتاج تصعيداً', en: 'NEWS2 Alert — Patient Requires Escalation' },
  qsofa_alert:          { ar: 'تنبيه: احتمال إنتان (qSOFA إيجابي)', en: 'ALERT: Possible Sepsis (qSOFA Positive)' },
  qsofa_desc:           { ar: 'ثلاثة معايير مجتمعة: تنفس سريع + ضغط منخفض + تغيير الوعي', en: '≥2 criteria met: High RR + Low BP + Altered consciousness' },
  notify_doctor:        { ar: 'إبلاغ الطبيب الآن', en: 'Notify Doctor Now' },

  // ---- Nursing Assessment Scales ----
  nr_assessments:       { ar: 'مقاييس التقييم التمريضي', en: 'Nursing Assessment Scales' },
  braden_scale:         { ar: 'مقياس برادن (تقرحات الضغط)', en: 'Braden Scale (Pressure Ulcer Risk)' },
  morse_scale:          { ar: 'مقياس مورس (خطر السقوط)', en: 'Morse Fall Scale' },
  gcs_scale:            { ar: 'مقياس غلاسكو للوعي', en: 'Glasgow Coma Scale (GCS)' },
  pain_scale:           { ar: 'مقياس الألم (NRS)', en: 'Pain Scale (NRS 0-10)' },
  assess_now:           { ar: 'تقييم الآن', en: 'Assess Now' },
  assess_history:       { ar: 'سجل التقييمات', en: 'Assessment History' },
  score_label:          { ar: 'الدرجة', en: 'Score' },
  ...
  morse_fall_history:   { ar: 'سقوط سابق (خلال 3 أشهر)', en: 'History of Falling (past 3 months)' },
  morse_sec_dx:         { ar: 'تشخيص ثانوي', en: 'Secondary Diagnosis' },
  morse_ambul_aid:      { ar: 'وسيلة المشي', en: 'Ambulatory Aid' },
  ...
  pain_none:            { ar: 'لا ألم (0)', en: 'No Pain (0)' },
  pain_mild:            { ar: 'ألم خفيف (1-3)', en: 'Mild Pain (1-3)' },
  pain_moderate:        { ar: 'ألم متوسط (4-6)', en: 'Moderate Pain (4-6)' },
  pain_severe:          { ar: 'ألم شديد (7-10)', en: 'Severe Pain (7-10)' },
  assess_saved:         { ar: 'تم حفظ التقييم', en: 'Assessment saved' },

  // ---- Order Sets ----
  order_sets:           { ar: 'بروتوكولات الطوارئ', en: 'Clinical Protocols / Order Sets' },
  order_set_dka:        { ar: 'بروتوكول الحموضة السكرية (DKA)', en: 'DKA Protocol' },
  order_set_sepsis:     { ar: 'بروتوكول الإنتان (Sepsis Bundle)', en: 'Sepsis Bundle' },
  order_set_stroke:     { ar: 'بروتوكول السكتة الدماغية', en: 'Stroke Protocol' },
  order_set_chest_pain: { ar: 'بروتوكول ألم الصدر / ACS', en: 'Chest Pain / ACS Protocol' },
  order_set_applied:    { ar: 'تم تطبيق البروتوكول بنجاح', en: 'Protocol applied successfully' },
  order_set_confirm:    { ar: 'هل تريد تطبيق هذا البروتوكول؟ سيتم إنشاء طلبات التحاليل والأدوية والمهام تلقائياً.', en: 'Apply this protocol? Lab orders, medications, and tasks will be created automatically.' },
  apply_set:            { ar: 'تطبيق البروتوكول', en: 'Apply Protocol' },
  ...
  fluid_net:            { ar: 'الصافي', en: 'Net Balance' },
  fluid_iv:             { ar: 'وريدي', en: 'IV Fluid' },
  fluid_oral:           { ar: 'فموي', en: 'Oral' },
  fluid_urine:          { ar: 'بول', en: 'Urine' },
  fluid_drain:          { ar: 'تصريف', en: 'Drain' },
  fluid_other:          { ar: 'أخرى', en: 'Other' },
  fluid_amount:         { ar: 'الكمية (مل)', en: 'Amount (mL)' },
  ...
  nr_fluids:            { ar: 'الدخل والخرج', en: 'Fluid Balance (I&O)' },
  shift_total:          { ar: 'إجمالي المناوبة', en: 'Shift Total' },
  daily_total:          { ar: 'إجمالي اليوم', en: 'Daily Total' },

  // ---- Discharge & SBAR Checklists ----
  discharge_checklist:  { ar: 'قائمة التحقق قبل التخريج', en: 'Pre-Discharge Checklist' },
  dc_check_meds:        { ar: 'تمت مراجعة ومطابقة الأدوية', en: 'Medications reconciled' },
  dc_check_edu:         { ar: 'تم تثقيف المريض / العائلة', en: 'Patient/family education completed' },
  dc_check_followup:    { ar: 'تم حجز موعد المتابعة', en: 'Follow-up appointment scheduled' },
  dc_check_transport:   { ar: 'تم ترتيب وسيلة النقل', en: 'Transport arranged' },
  dc_check_summary:     { ar: 'تم إعداد ملخص التخريج', en: 'Discharge summary prepared' },
  dc_check_labs:        { ar: 'تمت مراجعة جميع نتائج التحاليل', en: 'All lab results reviewed' },
  sbar_checklist:       { ar: 'قائمة تحقق التسليم', en: 'Handoff Checklist' },
  sbar_check_vitals:    { ar: 'تم التحقق من العلامات الحيوية لجميع المرضى', en: 'Vitals checked for all patients' },
  sbar_check_meds:      { ar: 'تم إعطاء جميع الأدوية المجدولة', en: 'All scheduled medications given' },
  sbar_check_critical:  { ar: 'تم إبلاغ الطبيب بأي نتائج حرجة', en: 'Doctor notified of any critical results' },
  sbar_check_iv:        { ar: 'تم فحص جميع مواقع الوريد', en: 'All IV sites checked' },
  sbar_check_tasks:     { ar: 'لا توجد مهام معلقة دون تفسير', en: 'No pending tasks left unexplained' },

  // ---- QR Wristband ----
  print_wristband_btn:  { ar: 'طباعة سوار المعصم', en: 'Print Wristband' },
  ...
  print_qr:             { ar: 'طباعة رمز QR', en: 'Print QR' },
  ...
  ecg_rate:             { ar: 'معدل القلب', en: 'Heart Rate' },
  ecg_rhythm:           { ar: 'نظم القلب', en: 'Rhythm' },
  ecg_interpretation:   { ar: 'التفسير الكلي', en: 'ECG Interpretation' },
